...
export function InventoryStatusCard({
        ...
        <div className="h-full bg-white rounded-xl flex flex-col items-center justify-center">
          <div className="flex flex-col items-center space-y-1 md:space-y-2">
            ...
            <div className="space-y-1 md:space-y-2 flex flex-col items-center">
              <div className="h-5 md:h-7 bg-gray-200 rounded w-20 animate-pulse" />
              <div className="h-5 md:h-7 bg-gray-200 rounded w-36 animate-pulse" />
            </div>
          </div>
        </div>
  ...
  return (
    <div
      className={`relative rounded-xl border-2 h-[13rem] md:h-[10rem] ${config.borderColor} overflow-hidden ${config.buttonBg} flex flex-col`}
    >
      {/* Upper white section */}
      <div className=" h-full bg-white rounded-xl flex flex-col items-center justify-center">
        <div className="flex flex-col items-center space-y-1 md:space-y-2 rounded-xl">
          ...
          <div className="text-center">
            <h2 className="text-base md:text-lg font-bold text-gray-900 mb-0.5 md:mb-1">{status}</h2>
            <p className="text-base md:text-lg text-gray-700">Inventory Status</p>
          </div>
        </div>
      </div>
