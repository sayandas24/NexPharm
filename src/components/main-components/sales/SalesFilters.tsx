        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex gap-2">
            {periods.map((p) => (
              <Button
                key={p.value}
                variant={!isCustomRange && period === p.value ? 'default' : 'outline'}
                size="sm"
                onClick={() => {
            ...
            <Popover>
              ...
              <PopoverContent className="w-auto p-0">
                <Calendar
                  ...
                  onSelect={(date) =>
                    onCustomDateChange({ ...customDateRange, start: date || null })
                  }
                  initialFocus
                />
              </PopoverContent>
            ...
            <Popover>
              ...
              <PopoverContent className="w-auto p-0">
                <Calendar
                  ...
                  onSelect={(date) =>
                    onCustomDateChange({ ...customDateRange, end: date || null })
                  }
                  initialFocus
                  disabled={(date) =>
