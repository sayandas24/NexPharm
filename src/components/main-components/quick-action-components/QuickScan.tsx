  ...
  return (
    <div>
      <button
          ...
          className="group w-full relative overflow-hidden rounded-xl bg-gradient-to-br from-blue-300 to-blue-600 p-6 text-left shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105 active:scale-100"
        >
          ...
          <div className="relative">
            ...
            <p className="text-blue-100 text-sm">Check stock instantly</p>
          </div>
        </button>
